        ...
        <div class="card shadow-lg text-center pt-4 pb-4 ">
            ...
            <h2 class="article-content">E-mail : {{email}}</h2>
                ...
                <div v-if="profil===true" class="row col-10 offset-1">
                    <button class="btn btn--groupomania__blue col-4 offset-4 mt-2 mb-2" type="button" data-toggle="collapse" data-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                        Modifier
                    </button>
                    ...
                    <div class="card shadow-sm">
                        <div class="card-body">
                            ...
                            <div v-if="isAdmin == 1" class="row mt-5">
                                ...
                                <!-- Trigger the modal with a button -->
                                <button @click="getPosts(user.id)" type="button" id="btnModal" class="col-4 btn btn--groupomania__blue" data-toggle="modal" :data-target="'#myModal'+user.id" aria-expanded="false">Posts</button>
                                <!-- Modal -->
                                ...
                                <div class="offset-7 col-1 ">
                                       <a @click="deleteProfilAdmin(user.id)" ><i class="offset-11 far fa-trash-alt poubelle text-danger"></i></a>
                                </div>
                            </div>
                        </div>
            </div>
